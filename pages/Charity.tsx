                    ...
                    <div className="p-6 bg-amber-50 dark:bg-amber-900/20 border-2 border-dashed border-amber-200 dark:border-amber-800 rounded-[2rem] flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-amber-800 dark:text-amber-300 font-medium leading-relaxed">
                                Платформа «Простор» является информационной витриной и не аккумулирует денежные средства на своих счетах. Все пожертвования направляются напрямую организаторам. Помогайте ответственно.
                            </p>
                        </div>
                    </div>
