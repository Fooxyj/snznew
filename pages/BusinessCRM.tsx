...
import { Loader2, LayoutDashboard, ShoppingBag, Calendar, Users, Settings, Megaphone, Menu, X, LogOut, Film, Repeat, ChevronDown, PlusCircle, Check, PlaySquare, Layout as LayoutIcon, Briefcase, Hammer, Star, Building2, Newspaper } from 'lucide-react';
...
export const BusinessCRM: React.FC = () => {
    ...
    return (
        <div className="flex flex-col lg:flex-row h-[calc(100vh-64px)] bg-[#F8FAFC] dark:bg-gray-950 overflow-hidden">
                    ...
                    <div className="relative">
                        ...
                        >
                            ...
                            <div className="flex-1 text-left min-w-0">
                                ...
                                <div className="text-sm font-bold dark:text-white truncate pr-4">{selectedBusiness?.name}</div>
                            </div>
            ...
            <main className="flex-1 overflow-auto p-4 lg:p-10 relative">
                {isBusinessDropdownOpen && <div className="fixed inset-0 bg-transparent z-[55] lg:hidden" onClick={() => setIsBusinessDropdownOpen(false)}></div>}
